...
# Data
var index: int
var expense_list: Array[OutingActivityExpense]
...
func set_up(p_index: int):
	...
	# Prefabs
	prefab_expense = load(SceneMain.instance.manager.resource.prefab.outing_activity_expense)
...
func _on_new_expense_button_pressed():
	var new_expense: OutingActivityExpense = prefab_expense.instantiate()
